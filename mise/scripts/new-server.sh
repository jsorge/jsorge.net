...
main() {
	...
	echo "     cd /var/www/jsorge.net && mise run serve"
	echo ""
	echo "  4. Update DNS (Cloudflare) to point jsorge.net to $DROPLET_IP"
	echo ""
	echo "  5. Update GitHub secrets with new SSH_HOST IP if changed"
	echo ""
